from core import resume_handlers, resume_intelligence


HANDLERS = {
    "resume_intelligence.get_resume_intelligence_report": resume_intelligence.get_resume_intelligence_report,
    "resume_intelligence.get_resume_recommendations": resume_intelligence.get_resume_recommendations,
    "resume_intelligence.get_resume_intelligence": resume_intelligence.get_resume_intelligence,
    "resume_intelligence.get_best_resume_action": resume_intelligence.get_best_resume_action,
