...
def test_routing_plan_selects_set_keyword_coverage_handler():
    from core.router import get_routing_plan
...
def test_routing_plan_selects_add_missing_keyword_handler():
    from core.router import get_routing_plan
...
def test_routing_plan_selects_set_resume_target_role_handler():
    from core.router import get_routing_plan

    plan = get_routing_plan("set resume target role Python Developer")
...
def test_routing_plan_selects_search_applications_handler():
    from core.router import get_routing_plan
...
def test_routing_plan_selects_application_interview_reminders_handler():
    from core.router import get_routing_plan

    plan = get_routing_plan("interview reminders")

    assert plan["handler"] == "job_application_handlers.handle_get_application_interview_reminders"

def test_routing_plan_selects_application_interview_result_handler():
    from core.router import get_routing_plan

    plan = get_routing_plan("view interview result 1")

    assert plan["handler"] == "job_application_handlers.handle_get_application_interview_result"

def test_routing_plan_selects_application_follow_up_reminders_handler():
    from core.router import get_routing_plan
...
def test_routing_plan_selects_joining_checklist_handler():
    from core.router import get_routing_plan
